...
Docker container that periodically syncs a Amazon S3 Bucket to a folder using the [AWS Command Line Interface tool](https://aws.amazon.com/cli/) and cron.

## Usage

    docker run -d [OPTIONS] flaviomrjr/aws-s3-sync
